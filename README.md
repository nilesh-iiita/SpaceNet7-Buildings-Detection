...
![](https://github.com/Rim-chan/SpaceNet7-Buildings-Detection/blob/main/SN7_images_masks/SN7_sample.PNG)


   Figure 1: An image and its corresponding mask sample from the SN7 dataset

![](https://github.com/Rim-chan/SpaceNet7-Buildings-Detection/blob/main/SN7_images_masks/patchified%20samples.PNG)


   Figure 2: Patchified image and its corresponding mask sample from the SN7 dataset
